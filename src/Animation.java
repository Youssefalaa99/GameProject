...
public class Animation {
	...
	private int newXLazy;
	private int newYLazy;
	private int newXArrogent;
	private int newYArrogent;
	private int newXBrave1;
	private int newYBrave1;
	private int newXBrave2;
	private int newYBrave2;
	...
	public void moveFarmer1(ImageView farmer1Img) {
		...
		for (int i = 0; i < model.getLeftBankCrossers().size(); i++) {
			if (model.getLeftBankCrossers().get(i).getWeight() == 90 && model.getBoatRiders().size() < 2
					&& model.getIsBoatOnTheLeftBank()) {
	...
	public void moveFarmer2(ImageView farmer2Img) {
		...
		for (int i = 0; i < model.getLeftBankCrossers().size(); i++) {
			if (model.getLeftBankCrossers().get(i).getWeight() == 80 && model.getBoatRiders().size() < 2
					&& model.getIsBoatOnTheLeftBank()) {
	...
	public void moveFarmer3(ImageView farmer3Img) {
		...
		for (int i = 0; i < model.getLeftBankCrossers().size(); i++) {
			if (model.getLeftBankCrossers().get(i).getWeight() == 60 && model.getBoatRiders().size() < 2
					&& model.getIsBoatOnTheLeftBank()) {
	...
	public void moveFarmer4(ImageView farmer4Img) {
		...
		for (int i = 0; i < model.getLeftBankCrossers().size(); i++) {
			if (model.getLeftBankCrossers().get(i).getWeight() == 40 && model.getBoatRiders().size() < 2
					&& model.getIsBoatOnTheLeftBank()) {
				newXFarmer4 += 111;
				newYFarmer4 += 61;
				move1.setByX(111);
	...
	public void moveLazy(ImageView lazyImg) {
		move1.setNode(lazyImg);
		for (int i = 0; i < model.getRightBankCrossers().size(); i++) {
			if (model.getRightBankCrossers().get(i).getLabelToBeShown().equals("Lazy") && model.getBoatRiders().size() < 2
					&& !model.getIsBoatOnTheLeftBank()) {
				newXLazy += -51;
				newYLazy += 105;
				model.getBoatRiders().add(model.getRightBankCrossers().get(i));
		...
		for (int i = 0; i < model.getBoatRiders().size(); i++) {
			if (model.getBoatRiders().get(i).getLabelToBeShown().equals("Lazy")) {
				if (!model.getIsBoatOnTheLeftBank()) {
					newXLazy += 51;
					newYLazy += -105;
					model.getRightBankCrossers().add(model.getBoatRiders().get(i));
		...
		for (int i = 0; i < model.getLeftBankCrossers().size(); i++) {
			if (model.getLeftBankCrossers().get(i).getLabelToBeShown().equals("Lazy") && model.getBoatRiders().size() < 2
					&& model.getIsBoatOnTheLeftBank()) {
				newXLazy += 123;
				newYLazy += 87;
				move1.setByX(123);
	...
	public void moveArrogent(ImageView arrogentImg) {

		move1.setNode(arrogentImg);

		for (int i = 0; i < model.getRightBankCrossers().size(); i++) {
			if (model.getRightBankCrossers().get(i).getLabelToBeShown().equals("Arrogant") && model.getBoatRiders().size() < 2
					&& !model.getIsBoatOnTheLeftBank()) {
				model.getBoatRiders().add(model.getRightBankCrossers().get(i));
				model.getRightBankCrossers().remove(i);
				newXArrogent += 28;
		...
		for (int i = 0; i < model.getBoatRiders().size(); i++) {
			if (model.getBoatRiders().get(i).getLabelToBeShown().equals("Arrogant")) {
				if (!model.getIsBoatOnTheLeftBank()) {
					model.getRightBankCrossers().add(model.getBoatRiders().get(i));
					model.getBoatRiders().remove(i);
					newXArrogent += -28;
		...
		for (int i = 0; i < model.getLeftBankCrossers().size(); i++) {
			if (model.getLeftBankCrossers().get(i).getLabelToBeShown().equals("Arrogant") && model.getBoatRiders().size() < 2
					&& model.getIsBoatOnTheLeftBank()) {
	...
	public void moveBrave1(ImageView braveImg1) {

		move1.setNode(braveImg1);
		for (int i = 0; i < model.getRightBankCrossers().size(); i++)

			if (model.getRightBankCrossers().get(i).getLabelToBeShown().equals("Brave1") && model.getBoatRiders().size() < 2
					&& !model.getIsBoatOnTheLeftBank()) {
		...
		for (int i = 0; i < model.getBoatRiders().size(); i++) {
			if (model.getBoatRiders().get(i).getLabelToBeShown().equals("Brave1")) {
				if (!model.getIsBoatOnTheLeftBank()) {					
					model.getRightBankCrossers().add(model.getBoatRiders().get(i));
					model.getBoatRiders().remove(i);
					newXBrave1 += -158;
		...
		for (int i = 0; i < model.getLeftBankCrossers().size(); i++) {
			if (model.getLeftBankCrossers().get(i).getLabelToBeShown().equals("Brave1") && model.getBoatRiders().size() < 2
					&& model.getIsBoatOnTheLeftBank()) {
				model.getBoatRiders().add(model.getLeftBankCrossers().get(i));
				model.getLeftBankCrossers().remove(i);
				newXBrave1 += -90;
	...
	public void moveBrave2(ImageView braveImg2) {
		move1.setNode(braveImg2);
		for (int i = 0; i < model.getRightBankCrossers().size(); i++) {
			if (model.getRightBankCrossers().get(i).getLabelToBeShown().equals("Brave2") && model.getBoatRiders().size() < 2
					&& !model.getIsBoatOnTheLeftBank()) {
		...
		for (int i = 0; i < model.getBoatRiders().size(); i++) {
			if (model.getBoatRiders().get(i).getLabelToBeShown().equals("Brave2")) {
		...
		for (int i = 0; i < model.getLeftBankCrossers().size(); i++) {
			if (model.getLeftBankCrossers().get(i).getLabelToBeShown().equals("Brave2") && model.getBoatRiders().size() < 2
					&& model.getIsBoatOnTheLeftBank()) {
	...
	public int getNewXLazy() {
		return newXLazy;
	}

	public int getNewYLazy() {
		return newYLazy;
	}

	public int getNewXArrogent() {
		return newXArrogent;
	}

	public int getNewYArrogent() {
		return newYArrogent;
	}

	public int getNewXBrave1() {
		return newXBrave1;
	}

	public int getNewYBrave1() {
		return newYBrave1;
	}

	public int getNewXBrave2() {
		return newXBrave2;
	}

	public int getNewYBrave2() {
		return newYBrave2;
	}
