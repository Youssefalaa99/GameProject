...
public class Animation {
	...
	public void movePlant(ImageView plantImg) {
		...
		for (int i = 0; i < model.getRightBankCrossers().size(); i++) {
			if (model.getRightBankCrossers().get(i) instanceof Plant && model.getBoatRiders().size() < 2 && !model.getIsBoatOnTheLeftBank()) {
				newXPlant += -51;
				newYPlant += 105;
		...
		for (int i = 0; i < model.getLeftBankCrossers().size(); i++) {
			if (model.getLeftBankCrossers().get(i) instanceof Plant && model.getBoatRiders().size() < 2 && model.getIsBoatOnTheLeftBank()) {
				newXPlant += 123;
				newYPlant += 87;
				move1.setByX(123);
				move1.setByY(87);
	...
	public void moveCarni(ImageView carniImg) {
		...
		for (int i = 0; i < model.getRightBankCrossers().size(); i++) {
			if (model.getRightBankCrossers().get(i) instanceof Carnivorous && model.getBoatRiders().size() < 2 && !model.getIsBoatOnTheLeftBank()) {
				model.getBoatRiders().add(model.getRightBankCrossers().get(i));
				model.getRightBankCrossers().remove(i);
				newXCarni += 28;
				newYCarni += 134;
		...
		for (int i = 0; i < model.getLeftBankCrossers().size(); i++) {
			if (model.getLeftBankCrossers().get(i) instanceof Carnivorous && model.getBoatRiders().size() < 2&& model.getIsBoatOnTheLeftBank()) {
	...
	public void moveHerbi(ImageView herbiImg) {
		...
		for (int i = 0; i < model.getRightBankCrossers().size(); i++)
			...
			if (model.getRightBankCrossers().get(i) instanceof Herbivorous && model.getBoatRiders().size() < 2 && !model.getIsBoatOnTheLeftBank()) {
		...
		for (int i = 0; i < model.getLeftBankCrossers().size(); i++) {
			if (model.getLeftBankCrossers().get(i) instanceof Herbivorous && model.getBoatRiders().size() < 2 && model.getIsBoatOnTheLeftBank() ) {
				model.getBoatRiders().add(model.getLeftBankCrossers().get(i));
				model.getLeftBankCrossers().remove(i);
				newXHerbi += -90;
				newYHerbi += 143;
	...
	public void moveFarmer(ImageView farmerImg) {
		...
		for (int i = 0; i < model.getRightBankCrossers().size(); i++) {
			if (model.getRightBankCrossers().get(i) instanceof Farmer && model.getBoatRiders().size() < 2 && !model.getIsBoatOnTheLeftBank() ) {
		...
		for (	int i = 0; i < model.getLeftBankCrossers().size(); i++) {
			if (model.getLeftBankCrossers().get(i) instanceof Farmer && model.getBoatRiders().size() < 2 && model.getIsBoatOnTheLeftBank()) {
	...
	public void moveFarmer1(ImageView farmer1Img) {
		...
		for (int i = 0; i < model.getRightBankCrossers().size(); i++) {
			if (model.getRightBankCrossers().get(i).getWeight() == 90 && model.getBoatRiders().size() < 2 && !model.getIsBoatOnTheLeftBank()) {
		...
		for (int i = 0; i < model.getLeftBankCrossers().size(); i++) {
			if (model.getLeftBankCrossers().get(i).getWeight() == 90 && model.getBoatRiders().size() < 2 && model.getIsBoatOnTheLeftBank() )  {
	...
	public void moveFarmer2(ImageView farmer2Img) {
		...
		for (int i = 0; i < model.getRightBankCrossers().size(); i++) {
			if (model.getRightBankCrossers().get(i).getWeight() == 80 && model.getBoatRiders().size() < 2 && !model.getIsBoatOnTheLeftBank()) {
		...
		for (int i = 0; i < model.getLeftBankCrossers().size(); i++) {
			if (model.getLeftBankCrossers().get(i).getWeight() == 80 && model.getBoatRiders().size() < 2 && model.getIsBoatOnTheLeftBank() ) {
				System.out.println("80KG");
	...
	public void moveFarmer3(ImageView farmer3Img) {
		...
		for (int i = 0; i < model.getRightBankCrossers().size(); i++) {
			if (model.getRightBankCrossers().get(i).getWeight() == 60 && model.getBoatRiders().size() < 2 && !model.getIsBoatOnTheLeftBank() ) {
		...
		for (int i = 0; i < model.getLeftBankCrossers().size(); i++) {
			if (model.getLeftBankCrossers().get(i).getWeight() == 60 && model.getBoatRiders().size() < 2 && model.getIsBoatOnTheLeftBank()) {
	...
	public void moveFarmer4(ImageView farmer4Img) {
		...
		for (int i = 0; i < model.getRightBankCrossers().size(); i++) {
			if (model.getRightBankCrossers().get(i).getWeight() == 40 && model.getBoatRiders().size() < 2 && !model.getIsBoatOnTheLeftBank()) {
		...
		for (int i = 0; i < model.getLeftBankCrossers().size(); i++) {
			if (model.getLeftBankCrossers().get(i).getWeight() == 40 && model.getBoatRiders().size() < 2 && model.getIsBoatOnTheLeftBank()) {
System.out.println("40KG");
	...
	public void moveAnimal(ImageView AnimalImg) {
		...
		for (int i = 0; i < model.getRightBankCrossers().size(); i++) {
			if (model.getRightBankCrossers().get(i).getWeight() == 20 && model.getBoatRiders().size() < 2 && !model.getIsBoatOnTheLeftBank() ) {
		...
		for (int i = 0; i < model.getLeftBankCrossers().size(); i++) {
			if (model.getLeftBankCrossers().get(i).getWeight() == 20  && model.getBoatRiders().size() < 2 && model.getIsBoatOnTheLeftBank() ) {
