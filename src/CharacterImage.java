...
public class CharacterImage {
    ...
    public CharacterImage(){
        try{
            ...
            braveKnightLeft=ImageIO.read(new FileInputStream("braveKnight.png"));
            braveKnightRight=ImageIO.read(new FileInputStream("braveKnight.png"));
            lazyKnightLeft=ImageIO.read(new FileInputStream("lazyKnight.png"));
            lazyKnightRight=ImageIO.read(new FileInputStream("lazyKnight.png"));
            arrogantKnightLeft=ImageIO.read(new FileInputStream("arrogantKnight.png"));
            arrogantKnightRight=ImageIO.read(new FileInputStream("arrogantKnight.png"));
